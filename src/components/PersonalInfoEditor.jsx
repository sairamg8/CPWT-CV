...
import { User, Mail, Phone, MapPin, Globe, Link, Code, FileText, Camera, Eye, EyeOff } from 'lucide-react';
...
export default function PersonalInfoEditor({ personal, updatePersonal, toggleFieldVisibility, settings, updateSetting }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-4 p-3 bg-gray-50 rounded-xl border border-gray-100">
        <p className="text-[11px] font-bold text-gray-500 uppercase tracking-widest">Header</p>
        ...
        {/* Details Arrangement */}
        <div>
          <p className="text-xs font-semibold text-gray-700 mb-2">Details Arrangement</p>
      ...
      <div className="space-y-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
        <div className="flex items-center justify-between">
          ...
          {personal.photo && (
            <button
              onClick={() => toggleFieldVisibility('photo')}
